...
export const updateSelectedItemIndex = (newItemIndex: {
  idx: number;
  name: string;
}) => ({
  type: UPDATE,
...
type selectedServiceAction = ReturnType<typeof updateSelectedItemIndex>;
...
const selectedService = (
  state: selectedServiceState = initialState,
